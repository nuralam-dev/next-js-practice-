...
<p className="text-gray-800 dark:text-gray-300 mt-3 font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi ipsam odio reprehenderit libero quo aliquid, velit perferendis nihil esse cumque!</p>
